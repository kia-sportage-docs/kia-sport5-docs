...
Причиной такого поведения является неправильно настроенный актуатор турбины. Есть несколько вариантов решения: самостоятельно (инструкция ниже) или обратиться в сервис, где смогут выполнить эти мероприятия. Однако, не все сервисы готовы за это браться или предлагают снятие турбины и настройку на стенде. Ниже есть список сервисов, которые решают эту проблему без снятия турбины по инструкции, размещенной на данной странице

## Список сервисов и мастеров, которые беруться за настройку актуатора турбины

| Город | СТО / мастер | Контакты |
| --- | ---| ---| 
| Самара | Алексей (электрик) | [+ 7 - 9 3 7 - 1 7 5 - 2 7 - 4 4](tel:+79371752744)  |

## Самостоятельное устранение (порядок действий):
...
5. Регулировка:
    - подключаем диагностический комп к машине, выбираем блок управления геометрией и смотрим напряжение, которое выдает шток при полном открытии геометрии, если оно больше 4.2V (± 0.1V), крутим шток, чтобы стало 4.2V (± 0,1V).
